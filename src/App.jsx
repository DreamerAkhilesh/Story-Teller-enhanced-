        ...
        contents: [
          {
            role: "user",
            parts: [
              { text: `Write a whimsical, engaging short story, in simple language for the kids, with exactly 5 paragraphs . For each paragraph, generate a corresponding animated-style illustration that:
